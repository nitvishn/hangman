...
word = "sc_i_______i_"
badletters = []
guess = getBestGuess("words2.txt", word, badletters=badletters)
# print(guess[0])
...
for char in alphabet:
    testWord = word.replace('X', char)
    # print(testWord, char, getBestGuess("words2.txt", testWord, badletters=badletters))
